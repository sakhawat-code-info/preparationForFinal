...
const Navbar = () => {
    const navLink = (
        <>
            ...
            <li>
                <NavLink to="/reg" className={({ isActive }) => (isActive ? "border-2 border-[#660746] text-[#660746] font-extrabold" : "relative border-2 border-[#F9E2E3]  rounded px-4 py-2 inline cursor-pointer font-extrabold text-[#660746] before:bg-[#660746] hover:rounded-b-none before:absolute before:-bottom-0 before:-left-0  before:block before:h-[3px] before:w-full before:origin-bottom-right before:scale-x-0 before:transition before:duration-300 before:ease-in-out hover:before:origin-bottom-left hover:before:scale-x-100 ")}>
                    <div className="flex items-center justify-center gap-2">
                        <IoHomeOutline size={18} />
                        <span>Home</span>
                    </div>
    ...
    return (
        <div>
            <div className="navbar bg-[#F9E2E3] fixed top-0">
                        ...
                        <li>
                            <details className="group">
                                ...
                                <article className=" absolute right-5 z-20 w-48 py-2 mt-2 origin-top-right bg-white rounded-md shadow-xl dark:bg-gray-800">
                                    ...
                                    <a href="#" className="flex items-center p-3 text-sm text-red-600 font-extrabold capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                                        <svg className="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
